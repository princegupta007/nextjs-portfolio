...
const ProjectsSection = () => {
  ...
  const projects = [
    {
      ...
      category: "Full Stack",
      description: "A modern e-commerce platform built with Next.js, featuring real-time inventory, payment processing, and advanced analytics dashboard.",
      longDescription: "This comprehensive e-commerce solution includes user authentication, shopping cart functionality, payment integration with Stripe, real-time inventory management, order tracking, and an admin dashboard with analytics. Built with performance and scalability in mind.",
    ...
    },
    {
      ...
      longDescription: "A comprehensive project management tool featuring Kanban boards, real-time collaboration, file uploads, time tracking, team management, and detailed reporting. Designed for teams of all sizes with a focus on productivity and ease of use.",
    ...
    },
    {
      ...
      longDescription: "This advanced analytics platform uses AI to analyze large datasets, generate insights, and provide predictive analytics. Features include data visualization, automated reporting, anomaly detection, and machine learning models for forecasting.",
      ...
      technologies: ["Python", "TensorFlow", "React", "D3.js", "PostgreSQL", "AWS"],
      github: "#",
      live: "#",
      featured: false
    },
    {
      ...
      longDescription: "A feature-rich social platform including user profiles, real-time messaging, content sharing, story features, privacy controls, and content moderation. Built with scalability and user experience as top priorities.",
      ...
      technologies: ["Next.js", "GraphQL", "PostgreSQL", "Redis", "AWS S3", "WebSockets"],
      github: "#",
      live: "#",
      featured: false
    },
    {
      ...
      category: "Finance",
      description: "A comprehensive cryptocurrency tracking application with portfolio management and market analysis tools.",
      longDescription: "A sophisticated crypto tracking platform featuring real-time price updates, portfolio management, technical analysis tools, price alerts, news integration, and detailed market analytics.",
      ...
      technologies: ["Vue.js", "Node.js", "Chart.js", "WebSockets", "CoinGecko API", "Firebase"],
      github: "#",
      live: "#",
      featured: false
    },
    {
      ...
      category: "Education",
      description: "An interactive learning platform with course creation, progress tracking, and collaborative learning features.",
      longDescription: "A comprehensive LMS featuring course creation tools, video streaming, interactive quizzes, progress tracking, discussion forums, and certification management. Designed for educators and learners alike.",
      ...
      technologies: ["React", "Django", "PostgreSQL", "AWS", "FFmpeg", "Stripe"],
      github: "#",
      live: "#",
      featured: false
    }
  ...
  const categories = ["All", "Full Stack", "Web App", "AI/ML", "Finance", "Education"];
                                ...
                                <div className="space-y-6">
                                  ...
                                  <div>
                                    ...
                                    <div className="flex space-x-4">
                                      <Button asChild>
                                        <a href={selectedProjectData.live} target="_blank" rel="noopener noreferrer">
