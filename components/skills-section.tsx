        ...
        >
          ...
          <motion.div variants={fadeInUp} className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ...
              expertise accumulated through years of hands-on development
              experience.
            </p>
          </motion.div>
            ...
            {skillCategories.map((category, categoryIndex) => (
              <motion.div
                ...
                animate={
                  inView
                    ? { opacity: 1, x: 0 }
                    : { opacity: 0, x: categoryIndex % 2 === 0 ? -50 : 50 }
                }
                ...
                <Card className="h-full border-border/20 hover:border-primary/20 transition-all duration-300 glass-effect">
                  <CardContent className="p-6">
                    <div className="flex items-center mb-6">
                      <div
                        className={`p-3 rounded-lg bg-background/50 ${category.color}`}
                      >
