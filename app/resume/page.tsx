...
const ResumePage = () => {
  ...
  const experience = [
    ...
    },
    {
      ...
      period: "2020 - 2022",
      location: "Jaipur, INDIA",
      description: "Developed MVP for multiple startup projects. Built responsive web applications and RESTful APIs from concept to production.",
      achievements: [
    ...
    },
    {
      ...
      period: "2019 - 2020",
      location: "Remote",
      description: "Specialized in creating responsive, accessible web interfaces. Collaborated with design teams to implement pixel-perfect UI components.",
      achievements: [
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <p className="text-muted-foreground">Notable projects and contributions</p>
              </motion.div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                  Interested in my background and experience? Let's discuss how I can contribute to your team.
                </p>
