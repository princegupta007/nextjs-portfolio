  ...
  const blogPosts = [
    {
      ...
      excerpt:
        'Learn how to leverage the latest features in Next.js 14 to build performant, scalable React applications with server components and improved routing.',
    ...
    },
    {
      ...
      excerpt:
        'Explore how AI is revolutionizing web development with intelligent code completion, automated testing, and smart debugging tools.',
      content: 'Full article content here...',
      author: 'Prince Gupta',
      date: '2024-01-05',
    ...
    },
    {
      ...
      excerpt:
        'Learn essential techniques for optimizing database queries, implementing caching strategies, and improving overall application performance.',
      content: 'Full article content here...',
      author: 'Prince Gupta',
      date: '2023-12-28',
    ...
    },
    {
      ...
      excerpt:
        'Master the art of web animations using Framer Motion. From basic transitions to complex orchestrated animations.',
      content: 'Full article content here...',
      author: 'Prince Gupta',
      date: '2023-12-20',
      readTime: '9 min read',
    ...
    },
    {
      ...
      excerpt:
        'A comprehensive guide to containerizing and deploying full-stack applications using Docker, AWS ECS, and modern DevOps practices.',
      content: 'Full article content here...',
      author: 'Prince Gupta',
      date: '2023-12-15',
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Sharing knowledge, best practices, and insights from the world
                of web development. From beginner tutorials to advanced
                techniques.
              </p>
            </motion.div>
          </div>
                      ...
                      <CardContent className="p-6 flex flex-col h-full">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            className="p-0 h-auto text-xs font-semibold group-hover:text-primary"
                          >
                            Read More
