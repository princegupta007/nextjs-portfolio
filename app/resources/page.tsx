...
import { Download, ExternalLink, Search, Filter, FileText, Code, BookOpen, Video, Link, Star, Calendar, Eye, Github, Globe, Zap, Lightbulb, PenTool as Tool, Palette } from 'lucide-react';
...
const ResourcesPage = () => {
  ...
  const resources = [
    {
      ...
      description: "A comprehensive starter template for building reusable React component libraries with TypeScript, Storybook, and automated testing.",
      category: "Templates",
      type: "download",
      format: "ZIP",
      size: "2.3 MB",
    ...
    },
    {
      ...
      description: "Complete guide with practical examples for optimizing Next.js applications for maximum performance and SEO.",
      category: "Guides",
      type: "pdf",
      format: "PDF",
      size: "5.1 MB",
    ...
    },
    {
      ...
      description: "Collection of 50+ CSS animations and transitions ready to use in your projects. Includes SCSS mixins and utility classes.",
      category: "Tools",
      type: "download",
      format: "ZIP",
      size: "1.8 MB",
    ...
    },
    {
      ...
      description: "Interactive roadmap covering modern full-stack development technologies, learning resources, and career guidance.",
      category: "Guides",
      type: "link",
      format: "Web",
      views: 15000,
    ...
    },
    {
      ...
      description: "Comprehensive checklist for designing RESTful APIs with examples, security considerations, and documentation templates.",
      category: "Checklists",
      type: "pdf",
      format: "PDF",
      size: "3.2 MB",
    ...
    },
    {
      ...
      description: "Video series covering the latest JavaScript features with practical examples and browser compatibility information.",
      category: "Videos",
      type: "link",
      format: "Video",
      duration: "2h 30m",
    ...
    },
    {
      ...
      description: "Complete Docker configuration for full-stack development with database, caching, and monitoring services.",
      category: "Templates",
      type: "download",
      format: "ZIP",
      size: "1.2 MB",
    ...
    },
    {
      ...
      description: "Complete design system with components, color palettes, typography, and Figma templates for consistent UI design.",
      category: "Design",
      type: "download",
      format: "Figma",
      size: "15.5 MB",
  ...
  const categories = ["All", "Templates", "Guides", "Tools", "Checklists", "Videos", "Design"];
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      case 'Templates': return <Code className="h-4 w-4" />;
      case 'Guides': return <BookOpen className="h-4 w-4" />;
      case 'Tools': return <Tool className="h-4 w-4" />;
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                A curated collection of templates, guides, tools, and resources to accelerate your development workflow. 
                All free to download and use in your projects.
              </p>
            </motion.div>
          </div>
        </section>
                        ...
                        <CardContent className="p-6">
                          <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="text-sm font-medium">{resource.format}</span>
                              {resource.size && (
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <Button size="sm" className="shadow-glow hover:shadow-glow-hover">
                              {getTypeIcon(resource.type)}
                              <span className="ml-2">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                  Get notified when new resources are added. Join our community of developers 
                  and never miss out on useful tools and templates.
                </p>
